...
ssh ubuntu@$1 "sudo certbot certonly --non-interactive --email support@azabab.com --agree-tos --dns-cloudflare --dns-cloudflare-credentials ./cloudflare.ini -d \"*.azabab.com\" -d \"*.$2\""
...
ssh ubuntu@$1 "sudo systemctl start haproxy.service"
echo ""
