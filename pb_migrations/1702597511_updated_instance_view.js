...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("hoqa9kug")

  // remove
  collection.schema.removeField("trpefhk3")

  // remove
  collection.schema.removeField("lfp1so2j")

  // remove
  collection.schema.removeField("amxmruaa")

  // remove
  collection.schema.removeField("oxqqlxxv")

  // remove
  collection.schema.removeField("toazorjk")

  // remove
  collection.schema.removeField("qjd331c7")
